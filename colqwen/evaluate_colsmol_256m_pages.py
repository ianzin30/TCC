"""Evaluate ColSmol 256M page retrieval against MMLongBench evidence pages.

Usage:
    uv run python evaluate_colsmol_256m_pages.py

The evaluator renders each PDF page, embeds pages with ColSmol 256M, ranks
...
ARCH_NAME = "colsmol_256m"
OUTPUT_STEM = "colsmol_256m-retrieval-pages"
...
PDF_INDEX_RANGE_ENV = "COLSMOL_256M_PDF_INDEX_RANGE"
...
CACHE_DIR = SCRIPT_DIR / "cache" / "colsmol_256m"
...
def _summarize(
    ...
    summary: dict[str, Any] = {
        ...
        "processing_duration_note": (
            "ColSmol 256M indexing duration includes PDF page rendering plus page "
